...
vconftool set -t string memory/telephony/imei "" -i -f -s system::vconf_system
vconftool set -t int memory/private/telephony/daemon_load_count 0 -i -f -s system::vconf_system
...
vconftool set -t int memory/telephony/zone_type 0 -i -f -s system::vconf_system
...
#fota script
/etc/opt/upgrade/500.tel-plugin-vconf.patch.sh
